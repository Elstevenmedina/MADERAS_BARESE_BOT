...
exports.getFullDate = exports.getMonth = exports.getMoment = exports.getDateFormatted = exports.getDate = exports.getDayWeek = void 0;
...
const getDateFormatted = () => (0, moment_timezone_1.default)().tz('America/Caracas').format('YYYY-MM-DD');
